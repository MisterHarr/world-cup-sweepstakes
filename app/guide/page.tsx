...
const TRANSFERS = [
  { label: "1 transfer per player", detail: "One swap for the entire tournament — make it count." },
  { label: "Window: after group stage", detail: "Opens after all group matches finish (after 28 June). Closes before the Round of 32 kicks off." },
  { label: "Drawn teams only", detail: "Your Star Team is locked — only drawn teams can be swapped." },
  {
    label: "Forward-only points",
    detail: "Your old team keeps every point they earned for you up to the moment of the swap. Your new team only earns points from matches that kick off AFTER the swap. Past performance is locked in — you can't pick up a team that already over-performed in the group stage and inherit those points.",
  },
  {
    label: "Costs points (tiered)",
    detail: "Teams are ranked Tier 1 (elite) to Tier 4 (underdog). Upgrading costs 2 pts base + 3 pts per tier step up. Example: Tier 4 → Tier 1 = 2 + (3 × 3) = 11 pts. Lateral moves (same tier) cost a flat 2 pts. Any downgrade costs a flat 1 pt. Minimum cost: 1 pt.",
  },
  { label: "No duplicates", detail: "You can't pick up a team already in your squad." },
  { label: "Any drawn team", detail: "Eliminated teams show a red “Eliminated” stamp in the Transfer tab so you can easily spot who to drop — but the choice is yours." },
];
...
const FAQS = [
  ...
  { q: "What happens if two players finish on the same score?", a: "Tiebreaker: total goals scored by the teams that earned you points. Under forward-only scoring that's your current 6 teams plus any team you swapped out (their goals from before the swap still count). If goals are also level, the prize pot is shared equally." },
  { q: "Can I sign up after the tournament has started?", a: "Registration closed when the first match kicked off (11 June). New sign-ups are no longer accepted for this edition." },
  { q: "How are transfer points calculated?", a: "Forward-only. Your old team keeps every point they earned for you up to the moment of the transfer; your new team only earns from matches that kick off AFTER the swap. So you can't grab a team that already over-performed in the group stage — only their remaining games count for you." },
  { q: "How much does a transfer cost? Give me an example.", a: "It depends on the tier gap. Teams are Tier 1 (elite, e.g. Brazil, Argentina) to Tier 4 (underdogs). Example: you hold Haiti (Tier 4) and upgrade to England (Tier 1) — cost is 2 + 3×3 = 11 pts. If England then win 3 knockout matches and score 6 goals with 2 clean sheets after the transfer, they earn 3×3 + 6×1.5 + 2×1 = 20 pts — a net gain of +9 pts. Moving sideways (same tier) costs a flat 2 pts; any downgrade costs a flat 1 pt. You always see the exact cost before confirming." },
];
