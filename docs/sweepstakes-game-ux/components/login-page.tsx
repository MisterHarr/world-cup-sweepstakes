...
import { Trophy, Mail, Lock, Eye, EyeOff, Sparkles } from "lucide-react"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-card/50 backdrop-blur-xl border border-border rounded-2xl p-8 shadow-2xl shadow-black/20">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground">Sign in to pick your team</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 bg-background/50 border-border h-12"
                />
                <button
                  type="button"
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-11 bg-background/50 border-border hover:bg-muted">
